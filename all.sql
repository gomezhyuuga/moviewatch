...
-- -----------------------------------------------------
-- Table `moviewatch`.`EurupeanCatalog`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `moviewatch`.`EurupeanCatalog` ;

CREATE TABLE IF NOT EXISTS `moviewatch`.`EurupeanCatalog` (
  `idFilm` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(100) NULL,
  `genre` VARCHAR(45) NULL,
  `rating` FLOAT NULL,
